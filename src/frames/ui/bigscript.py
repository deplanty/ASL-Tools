...
class Ui_BigScript:
    def __init__(self, BigScript:QMainWindow):
        ...
        self.r_n = QtWidgets.QSpinBox(frame)
        self.r_n.setMinimum(1)
        self.gridLayout.addWidget(self.r_n, 2, 3, 1, 1)
        # Compliance
        ...
        self.c_n = QtWidgets.QSpinBox(frame)
        self.c_n.setMinimum(1)
        self.gridLayout.addWidget(self.c_n, 3, 3, 1, 1)
        # Breath rate
        ...
        self.br_n = QtWidgets.QSpinBox(frame)
        self.br_n.setMinimum(1)
        self.gridLayout.addWidget(self.br_n, 4, 3, 1, 1)
        # Pmus
        ...
        self.i_pmus_n = QtWidgets.QSpinBox(frame)
        self.i_pmus_n.setMinimum(1)
        self.gridLayout.addWidget(self.i_pmus_n, 5, 3, 1, 1)
        # Pmus increase
        ...
        self.i_pmus_inc_n = QtWidgets.QSpinBox(frame)
        self.i_pmus_inc_n.setMinimum(1)
        self.gridLayout.addWidget(self.i_pmus_inc_n, 6, 3, 1, 1)
        # Pmus hold
        ...
        self.i_pmus_hld_n = QtWidgets.QSpinBox(frame)
        self.i_pmus_hld_n.setMinimum(1)
        self.gridLayout.addWidget(self.i_pmus_hld_n, 7, 3, 1, 1)
        # Pmus hold
        ...
        self.i_pmus_rel_n = QtWidgets.QSpinBox(frame)
        self.i_pmus_rel_n.setMinimum(1)
        self.gridLayout.addWidget(self.i_pmus_rel_n, 8, 3, 1, 1)
        # Repetitions
