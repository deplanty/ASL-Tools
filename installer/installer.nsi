...
;General
  ...
  Name "ASL-Tools"
  OutFile "..\target\Setup_ASL-Tools.exe"
...
;Pages
  ...
  !insertmacro MUI_PAGE_INSTFILES
    ...
    !define MUI_FINISHPAGE_RUN_TEXT "Run ASL-Tools"
...
!define UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\ASL-Tools"
Section
  SetOutPath "$InstDir"
  File /r "..\target\ASL-Tools\*"
  WriteRegStr SHCTX "Software\ASL-Tools" "" $InstDir
...
Section "Uninstall"
  RMDir /r "$InstDir"
  Delete "$SMPROGRAMS\ASL-Tools.lnk"
  Delete "$SMSTARTUP\ASL-Tools.lnk"
...
Function LaunchLink
  !addplugindir "."
  ShellExecAsUser::ShellExecAsUser "open" "$SMPROGRAMS\ASL-Tools.lnk"
FunctionEnd
